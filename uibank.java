...
public class uibank {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(400);
		driver.findElement(By.id("firstName")).sendKeys("nithi");
		WebElement findElement = driver.findElement(By.name("title"));
		Select iris=new Select(findElement);
		iris.selectByVisibleText("Ms");
		driver.findElement(By.id("middleName")).sendKeys("cherry");
		driver.findElement(By.name("lastName")).sendKeys("riooo");
